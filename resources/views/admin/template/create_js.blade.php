...
@section('body')
    <div class="page-container">
        <form class="form form-horizontal mt-50" method="post" enctype="multipart/form-data" action="{{route('admin.template.store.js')}}" >
            <div class="row cl">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">JS文件：</label>
                <div class="formControls col-xs-8 col-sm-4">
            ...
            <div class="row cl">
                <label class="form-label col-xs-4 col-sm-2">创建空JS文件：</label>
                <div class="formControls col-xs-8 col-sm-4">
            ...
            <div class="row cl">
                <div class="col-xs-8 col-sm-4 col-xs-offset-4 col-sm-offset-2">
                    <div class="btn-group mt-50">
                        ...
                        <a class="btn btn-default radius"  href=" {{route('admin.template.js')}}">取消</a>
                    </div>
                </div>
            </div>
        </form>
