...
class ColumnTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('columns',function (Blueprint $table){
            ...
            $table->string('keywoeds',160)->nullable()->comment('关键词');
            ...
            $table->smallInteger('page',false,true)->default(12)->comment('分页');
            $table->float('priority',3,2)->unsigned()->default(0.8)->comment('权重');
            $table->string('rel',100);
            $table->string('atl',100);
