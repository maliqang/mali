...
class TemplateTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('templates',function (Blueprint $table){
            ...
            $table->smallInteger('class',false,true)->nullable()->default(0)->comment('类型');
            $table->smallInteger('model',false,true)->nullable()->default(0)->comment("模型");
            $table->smallInteger('type',false,true)->nullable()->default(0)->comment('类别');
